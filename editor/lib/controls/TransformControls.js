...
(function () {
	...
	THREE.TransformControls = function ( camera, domElement, parentControls, windowSize ) {
		...
		this.update = function ( delta ) {
			...
			if ( scope.parentControls ) scope.parentControls.update( delta );
		...
		function onPointerDown( event ) {
			...
			if ( _dragging === true ) event.cancelled = true;
			...
			if ( pointer.button === 0 || pointer.button === undefined ) {
				...
				if ( intersect ) {
					...
					scope.parentControls.enabled = false;
		...
		function onPointerUp( event ) {
			...
			scope.parentControls.enabled = true;
			_dragging = false;
		...
		function intersectObjects( pointer, objects ) {
			...
			var x = pointer.pageX / windowSize.width;
			var y = pointer.pageY / windowSize.height;
